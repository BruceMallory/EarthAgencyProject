...
![(BioJftotal Model Fit Result)](D:/EarthAgencyProject/fit_result.png)
...
![(Biojtscore vs. Antjtscore (Child))](D:/EarthAgencyProject/child_group.png)
![(Biojtscore vs. Antjtscore (Adult))](D:/EarthAgencyProject/adult_group.png)
...
There are bars in the residual plot of the model, it looks not so good.So we think it's not a good choice to use the linear model for Meansever.
