...
If we transform the `invitalscores` by dividing # true by # of questions asked, we get a percent-true measure (#3a).  Binned percent-true (#3c), where we round to the nearest children's percent-true, also results in a a clumped adult distribution, with almost no adults in the bottom bin and almost half the adults in the third bin.  And binned percent-true (#3b), where we round up to the nearest 25%, results in an identical outcome to the compressing method (#1).    
